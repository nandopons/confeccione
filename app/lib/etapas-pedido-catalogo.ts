...
export const INFO_ETAPA: Record<Etapa, InfoEtapa> = {
  ...
  em_negociacao: { label: 'Em negociação', grupo: 'negociacao', cor: 'bg-blue-100 text-blue-800', alerta: false, descricao: 'Fornecedor aceitou; orçamento ainda não definido. Aos 3 dias, perguntar ao cliente se a conversa deu certo.' },
  orcamento_atrasado: { label: 'Orçamento atrasado', grupo: 'negociacao', cor: 'bg-orange-100 text-orange-800', alerta: true, descricao: 'Aceite há mais de 7 dias sem orçamento. Cutucar o fornecedor.' },
