  ...
  return (
    <main className="min-h-screen bg-white font-sans">
      ...
      <nav className="bg-[#111] px-6 py-4 flex items-center justify-between sticky top-0 z-40">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => setShowPopup(true)} className="text-white text-xs md:text-sm border border-white/20 px-3 md:px-4 py-2 rounded-full hover:bg-white/10 transition-colors">Sou fornecedor</button>
          <a href="https://wa.me/5581995782077?text=Ol%C3%A1%21%20Vim%20pelo%20site%20do%20Confeccione" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-white text-xs font-medium border border-white/20 px-3 py-1.5 rounded-full hover:bg-white/10 transition-colors">
      ...
      <a
        ...
        className="fixed bottom-20 md:bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-lg"
